            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rp. {{ number_format($transaction->product->harga_product*$transaction->qty)}} </td>
                        <td>
                            <button type="button" wire:click="deleteTransaction({{$transaction->id}})" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
